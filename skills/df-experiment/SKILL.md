...
|---------|-------------|
| `/df-experiment status <project-dir>` | Print memory summary: experiments, decisions, best pipeline |
| `/df-experiment compare <project-dir>` | Compare experiments across runs |
| `/df-experiment monitor <project-dir> --new-data <path>` | Data/concept drift detection |
...
- Suggest: `/df-modeling train {new_data} {target}`
