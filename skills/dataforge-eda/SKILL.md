...
## COMMAND: Full EDA (`/dataforge-eda <dataset>`)
...
## COMMAND: Single Column (`/dataforge-eda column <dataset> <col>`)
...
## COMMAND: Global Analysis (`/dataforge-eda global <dataset> [target]`)
...
## COMMAND: Summary (`/dataforge-eda summary <project-dir>`)
